...
#
# In order to run these tests, copy this module to your projectPython/rango/ directory.
...
class Chapter4StaticMediaTests(TestCase):
    ...
    def test_static_and_media_configuration(self):
        ...
        self.assertEqual(expected_path, media_path, f"{FAILURE_HEADER}The MEDIA_DIR setting does not point to the correct path. Remember, it should have an absolute reference to projectPython/media/.{FAILURE_FOOTER}")
